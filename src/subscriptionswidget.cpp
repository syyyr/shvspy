	...
	ui(new Ui::SubscriptionsWidget)
{
	...
	connect(ui->addSubsriptionButton,	&QPushButton::clicked, this, &SubscriptionsWidget::onAddSubscription);
	connect(ui->deleteSubscriptionButton, &QPushButton::clicked, this, &SubscriptionsWidget::onDeleteSubscription);
}
...
void SubscriptionsWidget::setShvPath(std::string path)
{
	ui->subscriptionPathLineEdit->setText(QString::fromStdString(path));
}

void SubscriptionsWidget::setSubscriptionsList(const QVariantList &subs)
{
...
QVariantList SubscriptionsWidget::subscriptionsList()
{
	return m_subscriptionList;
}

void SubscriptionsWidget::onDeleteSubscription()
{
...
void SubscriptionsWidget::onAddSubscription()
{
...
void SubscriptionsWidget::on_buttonBox_accepted(){
